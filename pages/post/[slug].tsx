...
function Post({ post }: Props) {
  ...
  return (
    <main>
        ...
        <div className="mt-10">
          <PortableText
            ...
            serializers={{
              ...
              normal: (props: any) => <p className="mt-5 mb-5" {...props} />,
      ...
      {submitted ? (
        <div className="flex flex-col py-10 my-10 max-w-2xl mx-auto mb-10 bg-yellow-500 text-white px-10">
          <h3 className="text-3xl font-bold">Thankyou for submitting</h3>
        ...
        >
          ...
          <input
            type="submit"
            className="shadow bg-yellow-500 hover:bg-yellow-400 focus:shadow-outline cursor-pointer focus:outline-none text-white font-bold py-2 px-4 rounded"
          />
        </form>
      )}
